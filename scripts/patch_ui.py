...
with open('dashboard/src/components/MultiRoleDashboard.js', 'w', encoding='utf-8') as f:
    f.write(content)

with open('dashboard/src/components/TeamAndDevices.js', 'w', encoding='utf-8') as f:
    f.write(content.replace('MultiRoleDashboard', 'TeamAndDevices'))
