...
class GeminiAIAssistant:
    ...
    async def chat(self, message: str, system_data: Optional[Dict] = None, 
        ...
        try:
            ...
            if system_data:
                enhanced_message = self.enhance_with_system_data(message, system_data)
            else:
                enhanced_message = f"{self.system_context}\n\nUser: {message}"
            ...
            ai_response = response.text if response.text else "I apologize, but I couldn't generate a response at this moment."
